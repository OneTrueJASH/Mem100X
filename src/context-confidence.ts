...
export class ContextConfidenceScorer {
  ...
  private readonly WEIGHTS = {
    ...
    entityType: 0.30,        // Entity type matches config
  ...
  private readonly HIGH_CONFIDENCE = 0.50;
  private readonly MEDIUM_CONFIDENCE = 0.30;
  ...
  shouldPromptUser(topScore: ContextScore, secondScore?: ContextScore): boolean {
    ...
    if (secondScore && (topScore.confidence - secondScore.confidence) < 0.10) return true;
