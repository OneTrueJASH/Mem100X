...
export class AsyncMultiDatabaseManager extends MultiDatabaseManager {
  ...
  async getNeighborsAsync(
    options: GetNeighborsOptions & { context?: string; entityName: string }
  ): Promise<GraphResult> {
  ...
  async findShortestPathAsync(
    options: FindShortestPathOptions & { context?: string; from: string; to: string }
